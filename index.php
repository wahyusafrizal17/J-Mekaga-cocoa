...
<head>
  ...
  <title>Beranda - Mega Kayan Ganesha</title>
  <meta name="description" content="Mega Kayan Ganesha - Perusahaan terpercaya dengan lini bisnis Mekaga Gadai, Mekaga Cocoa, dan Mekaga Farm">
  <meta name="keywords" content="Mega Kayan Ganesha, Mekaga Gadai, Mekaga Cocoa, Mekaga Farm">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="index.php#about">Hubungi Kami</a>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <h1 class="mb-4">
                Mega Kayan <br>
                Ganesha <br>
                <span class="accent-text">Solusi Terpercaya</span>
              </h1>

              <p class="mb-4 mb-md-5">
                Perusahaan terpercaya dengan tiga pilar bisnis utama: Mekaga Gadai untuk solusi keuangan, 
                Mekaga Cocoa untuk produk kakao berkualitas, dan Mekaga Farm untuk hasil pertanian terbaik.
              </p>

              <div class="hero-buttons">
                <a href="lini-bisnis.php" class="btn btn-primary me-0 me-sm-2 mx-1">Lini Bisnis</a>
                <a href="kontak.php" class="btn btn-link mt-2 mt-sm-0">
          ...
          <div class="col-lg-6">
            <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
              <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/illustration-1.webp" alt="Hero Image" class="img-fluid">

              <div class="customers-badge">
                <div class="customer-avatars">
                  <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-1.webp" alt="Customer 1" class="avatar">
                  <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-2.webp" alt="Customer 2" class="avatar">
                  <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-3.webp" alt="Customer 3" class="avatar">
                  <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-4.webp" alt="Customer 4" class="avatar">
                  <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-5.webp" alt="Customer 5" class="avatar">
                  <span class="avatar more">12+</span>
                </div>
                <p class="mb-0 mt-2">12,000+ pelanggan puas telah mempercayai layanan kami</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center justify-content-between">
          ...
          <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <h2 class="about-title">Mega Kayan Ganesha</h2>
            <p class="about-description">Mega Kayan Ganesha adalah perusahaan yang berkomitmen untuk memberikan solusi terbaik melalui tiga lini bisnis utama: Mekaga Gadai untuk layanan keuangan, Mekaga Cocoa untuk produk kakao berkualitas, dan Mekaga Farm untuk hasil pertanian organik. Kami hadir untuk melayani masyarakat dengan integritas dan profesionalitas tinggi.</p>
              ...
              <div class="row gy-4">
                <div class="col-lg-5">
                  <div class="profile d-flex align-items-center gap-3">
                    <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/avatar-1.webp" alt="CEO Profile" class="profile-image">
                    <div>
                      <h4 class="profile-name">Direktur Utama</h4>
                      <p class="profile-position">Mega Kayan Ganesha</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-7">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/about-5.webp" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="https://bootstrapmade.com/content/demo/iLanding/assets/img/about-2.webp" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            ...
            <p><strong>Email:</strong> <span><a href="mailto:info@megakayanganesha.com">info@megakayanganesha.com</a></span></p>
          </div>
